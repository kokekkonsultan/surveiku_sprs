...
$route['laporan-induk/(:any)/download-pdf'] = 'LaporanSurveyIndukController/download_pdf/$1/$2';
$route['laporan-induk/(:any)/download-docx'] = 'LaporanSurveyIndukController/download_docx/$1/$2';
...
//PEROLEHAN PER ANAK
$route['data-perolehan-per-anak'] = 'DataPerolehanPerAnakController/index';
$route['data-perolehan-per-anak/export'] = 'DataPerolehanPerAnakController/export';
$route['data-perolehan-per-anak/ajax-list'] = 'DataPerolehanPerAnakController/ajax_list';
$route['data-perolehan-per-anak/(:any)'] = 'DataPerolehanPerAnakController/detail/$1';
$route['data-perolehan-per-anak/(:any)/ajax-list'] = 'DataPerolehanPerAnakController/ajax_list_detail/$1';
...
//REKAP UNSUR INDUK
$route['rekap-unsur-induk'] = 'RekapUnsurIndukController/index';
$route['rekap-unsur-induk/proses'] = 'RekapUnsurIndukController/proses';
$route['rekap-unsur-induk/detail/(:num)'] = 'RekapUnsurIndukController/detail/$1';
$route['rekap-unsur-induk-all'] = 'RekapUnsurIndukController/unsur_keseluruhan';
$route['rekap-profil-induk'] = 'RekapUnsurIndukController/profil_keseluruhan';
$route['rekap-profil-induk/(:any)'] = 'RekapUnsurIndukController/profil_per_bagian/$1';
$route['rekap-terbuka-induk'] = 'RekapUnsurIndukController/terbuka_keseluruhan';
...
//JENIS LAYANAN SURVEI
$route['(:any)/(:any)/wilayah-survei'] = 'WilayahSurveiController/index/$1/$2';
$route['(:any)/(:any)/wilayah-survei/add'] = 'WilayahSurveiController/add/$1/$2';
$route['(:any)/(:any)/wilayah-survei/edit'] = 'WilayahSurveiController/edit/$1/$2';
$route['(:any)/(:any)/wilayah-survei/delete/(:num)'] = 'WilayahSurveiController/delete/$1/$2';
$route['(:any)/(:any)/grafik-wilayah'] = 'WilayahSurveiController/grafik/$1/$2';
