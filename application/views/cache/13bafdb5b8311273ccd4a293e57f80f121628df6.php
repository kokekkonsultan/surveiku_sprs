...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
        ...
        <ul class="menu-nav">
            ...
            <li class="menu-item menu-item-submenu <?php echo e($main_menu_active); ?>" aria-haspopup="true" data-menu-toggle="hover" style="display: none; ">
            ...
            <li class="menu-item menu-item-submenu <?php echo e($main_menu_active); ?>" aria-haspopup="true" data-menu-toggle="hover">
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        ?>
                        <li class="menu-item <?php echo e($child_menu_active); ?>" aria-haspopup="true">
                            <a href="<?php echo e(base_url()); ?>data-perolehan-per-anak" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
            ...
            <li class="menu-item menu-item-submenu <?php echo e($main_menu_active); ?>" aria-haspopup="true" data-menu-toggle="hover">
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        ?>
                        <li class="menu-item <?php echo e($child_menu_active); ?>" aria-haspopup="true">
                            <a href="<?php echo e(base_url()); ?>rekap-profil-induk" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                        ...
                        ?>
                        <li class="menu-item <?php echo e($child_menu_active); ?>" aria-haspopup="true">
                            <a href="<?php echo e(base_url()); ?>rekap-unsur-induk-all" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                        ...
                        ?>
                        <li class="menu-item <?php echo e($child_menu_active); ?>" aria-haspopup="true">
                            <a href="<?php echo e(base_url()); ?>rekap-terbuka-induk" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                        ...
                        ?>
                        <li class="menu-item <?php echo e($child_menu_active); ?>" aria-haspopup="true">
                            <a href="<?php echo e(base_url()); ?>rekap-unsur-induk" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Per Bagian</span>
...
</div><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\surveiku_sprs\application\views/include_backend/partials_backend/_aside_menu.blade.php ENDPATH**/ ?>