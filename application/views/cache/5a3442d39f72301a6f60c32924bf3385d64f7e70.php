    ...
    <table class="table table-borderless" width="100%" border="0">
            ...
            <td style="font-weight:bold;" width="95%">
                ...
                <div class="<?php echo e($model_tb); ?>-inline mb-2">
                    <label class="<?php echo e($model_tb); ?> <?php echo e($model_tb); ?>-outline <?php echo e($model_tb); ?>-success <?php echo e($model_tb); ?>-lg" style="font-size: 16px;">
                        <input type="<?php echo e($model_tb); ?>" name="jawaban_pertanyaan_terbuka[<?php echo e($row_terbuka_bawah->id_pertanyaan_terbuka); ?>][]" value="<?php echo e($value_terbuka->pertanyaan_ganda); ?>" class="terbuka_<?php echo e($row_terbuka_bawah->id_pertanyaan_terbuka); ?>" <?php echo e($is_required_tb_i); ?> <?= in_array($value_terbuka->pertanyaan_ganda, unserialize($row_terbuka_bawah->jawaban)) ? 'checked' : ''; ?>>
        ...
        <tr>
            ...
            <td style="font-weight:bold;" width="95%">
                ...
                <textarea class="form-control" type="text" name="jawaban_pertanyaan_terbuka[<?php echo e($row_terbuka_bawah->id_pertanyaan_terbuka); ?>][]" placeholder="Masukkan Jawaban Anda ..."><?php echo e($row_terbuka_bawah->jawaban != '' ?  implode("", unserialize($row_terbuka_bawah->jawaban)) : ''); ?></textarea>
            </td>
        </tr>
...
<?php endif; ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\surveiku_sprs\application\views/survei/pertanyaan_terbuka/_tanpa_kategori/form_terbuka_bawah.blade.php ENDPATH**/ ?>