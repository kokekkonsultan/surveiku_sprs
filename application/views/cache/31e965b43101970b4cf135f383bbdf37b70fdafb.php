...
<div class="d-lg-flex half">
	...
	<div class="bg order-1 order-md-2" style="background-image: url('<?php echo e(base_url()); ?>assets/img/site/auth/bg_4.jpg');">
		<div class="text-center text-white">
			<h5 class="pt-5">Survei Perilaku Pengguna Ruang Siber | <b>SurveiKu.com</b></h5>
		</div>
	</div>
		...
		<div class="container">
			<div class="row align-items-center justify-content-center">
				<div class="col-md-7">
					...
					<h3 class="text-white">Login ke <strong>sprs.surveiku.com</strong></h3>
...
<?php echo $__env->make('include_backend/template_auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\surveiku_sprs\application\views/auth/login.blade.php ENDPATH**/ ?>