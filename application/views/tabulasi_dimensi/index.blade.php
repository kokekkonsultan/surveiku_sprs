                    ...
                    <div class="table-responsive mt-5">
                        <table id="table" class="table table-bordered table-hover" cellspacing="0" width="100%"
                            ...
                            @foreach($ci->db->query("SELECT *,
                                (SELECT dimensi FROM dimensi_$table_identity WHERE id_dimensi = dimensi_$table_identity.id) AS nama_dimensi,
                                ...
                                GROUP BY id_dimensi")->result() as $row)
                           
                                <tr>
                                    <td>{{$no++}}</td>
                                    <td>{{$row->nama_dimensi}}</td>
                                ...
                                @php
                                $data_chart[] = '{label:"' . $row->nama_dimensi . '", value:"' . ROUND($row->skor,3) . '"}';
                                @endphp
                                @endforeach
