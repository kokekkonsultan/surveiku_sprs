...
<head>
    <!-- Google Fonts -->
    <title>SURVEI BELUM DIBUKA</title>
    <link
                ...
                <div class="shadow animate__animated animate__bounce" style="border-radius: 25px; padding: 20px; ">
                    <div class="row">
                        <div class="container d-flex flex-column align-items-center justify-content-center">
                            <img src="<?php echo base_url('assets/') ?>survey/img/survey-not-started.png"
                                style="weight:300; height:300px;">
                            <br>
                            <div class="text-center">
                                <div style="font-size: 18px;">Mohon maaf untuk saat ini survei</div>
                                <div style="font-size: 20px;"><b><?php echo $judul->survey_name ?></b></div>
                                <div style="font-size: 18px;">belum dimulai.</div>
                            </div>
                        </div>
                    </div>
                </div>
