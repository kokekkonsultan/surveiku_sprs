...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <p>
                Menu Pertanyaan harapan adalah semua data pertanyaan harapan. Anda bisa mensortirnya melalui menu
                filter.
            </p>
...
@include("pertanyaan_harapan/detail")
...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "{{ base_url() }}pertanyaan-harapan/ajax-list",
            "type": "POST",
            "data": function(data) {
