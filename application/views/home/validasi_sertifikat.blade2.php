...
.header_card {
    color: #ffffff;
    background: linear-gradient(105deg, rgba(176, 3, 0) 0%, rgba(226, 23, 7) 100%);
        ...
        <div class="col-md-5">
            <div class="card shadow aos-init aos-animate" style="border-radius: 25px;">
                ...
                <div class="card-body mt-3 mb-3">
                    ...
                    <div class="text-center" style="font-size:16px;">Kinerja Unit Pelayanan : <br>
                        <b> <?php
        ...
        <div class="col-md-7">
            <div class="card shadow aos-init aos-animate" style="border-radius: 25px;">
                ...
                <div class="card-body mt-3 mb-3" style="padding-left: 50px;">
                    ...
                    <div class="mt-3"><b>PERIODE SURVEY :</b> <?php echo $manage_survey->survey_mulai ?> s/d
