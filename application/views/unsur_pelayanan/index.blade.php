...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p>
                Menu Unsur Pelayanan adalah Unsur dari Klasifikasi & Jenis Pelayanan yang telah dibuat sebelumnya.
            </p>
            <div class="text-right mb-3">
                @php
                echo anchor(base_url().'unsur-pelayanan/add', 'Tambah Unsur Pelayanan', ['class' => 'btn btn-primary
            ...
            <form id="form-filter" class="">
                <div class="row mb-5">
                    <div class="col-md-6">
                        ...
                        <label for="jenis_pelayanan" class="form-label font-weight-bold text-primary">Filter Klasifikasi & Jenis Pelayanan</label>
                        <select name="jenis_pelayanan" id="jenis_pelayanan" class="form-control" onchange="updateUnit();">
                            ...
                            <option value="{{ $value->id_jenis_pelayanan }}">{{ $value->nama_klasifikasi_survei }} -- {{ $value->nama_jenis_pelayanan_responden }}</option>
                            @endforeach
                        </select>
...
<script>
    $(document).ready(function() {
        table = $('#table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "{{ base_url() }}unsur-pelayanan/ajax-list",
                "type": "POST",
                "data": function(data) {
