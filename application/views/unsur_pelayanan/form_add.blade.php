    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div>
                        <input type="radio" name="custom" id="default" value="2" class="custom"><label>&nbsp Tanpa Sub
                            Unsur</label><br>
                    </div>
                    <div>
                        <input type="radio" name="custom" id="custom" value="1" class="custom"><label>&nbsp Dengan Sub
                            Unsur</label><br>
                    </div>
                    <div class="mb-3">
                        @php
            ...
            <div class="text-right mt-3 mb-3">
                @php
                echo anchor(base_url().'unsur-pelayanan', 'Batal', ['class'=>'btn btn-light-primary font-weight-bold']);
                @endphp
