                    ...
                    <div>
                        ...
                        btn-primary btn-sm font-weight-bold dropdown-toggle" data-toggle="dropdown"
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                <a class="dropdown-item text-secondary" href="<?= base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) .
                                                                                    '/inovasi-dan-saran/cetak/' ?>"
                                    target="_blank"><i class=" fas fa-file-pdf text-dark"></i>&nbsp;&nbsp;
                                    <b>PDF</b></a>

                                <a class="dropdown-item text-secondary"
                                    href="{{ base_url() }}{{ $ci->session->userdata('username') }}/{{ $ci->uri->segment(2) }}/inovasi-dan-saran/download-docx"
...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/inovasi-dan-saran/ajax-list' ?>",
            "type": "POST",
            "data": function(data) {}
        },
