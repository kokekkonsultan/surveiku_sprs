                ...
                <tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a class="btn btn-secondary" href="javascript:void(0)"
                                                ...
                                                onclick="delete_data('<?php echo $row->id ?>')"><i
                    ...
                    <td valign="top">
                        <div class="col-sm-1 sticky_button_edit">
                            <div class="btn-group-vertical" data-aos="fade-up"
                                style="box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.19);">

                                <span data-toggle="modal" data-target="#default">
                                    <button class="btn btn-default" data-toggle="tooltip" data-placement="right"
                                        title="Tambah Profil dari Template" style="background-color: white;"><i
                                            class="fa fa-history"></i></button>
                                </span>

                                <span data-toggle="modal" data-target="#custom">
                                    <button class="btn btn-default" data-toggle="tooltip" data-placement="right"
                                        title="Custom Profil" style="background-color: white;"><i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- <span class="text-danger">* Pilih profil responden dibawah ini!</span> -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form
                    action="<?php echo base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/form-survei/edit-data-responden/' . $value->id ?>"
                    class="form_edit">

                    <input name="id_profil" value="{{$value->id}}">
                    <input name="jenis_isian" value="{{$value->jenis_isian}}">

                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label font-weight-bold">Nama Profil <span
                                style="color:red;">*</span></label>
                        <div class="col-sm-9">
                            <input class="form-control" name="edit_nama_profil_responden_{{$value->id}}"
