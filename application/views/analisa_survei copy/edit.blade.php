        ...
        <div class="col-md-9">
            ...
            <div class="card" data-aos="fade-down">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="id_layanan_survei" value="{{ $id_layanan_survei }}">
                    ...
                    <div class="text-right">
                        @php
                        echo
                        anchor(base_url().$ci->session->userdata('username').'/'.$ci->uri->segment(2).'/analisa-survei/detail-pelayanan/'.$id_layanan_survei,
