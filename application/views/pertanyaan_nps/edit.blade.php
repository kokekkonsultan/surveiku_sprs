        ...
        <div class="col-md-9">
            ...
            <div class="card" data-aos="fade-down">
                ...
                <div class="card-body">
                    ...
                    <form action="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/pertanyaan-nps/edit/' .  $ci->uri->segment(5)}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" type="text" name="isi_pertanyaan" rows="4"
                                id="isi_pertanyaan" placeholder="Isikan Pertanyaan ..." autofocus
                                required><?php echo $pertanyaan_nps->isi_pertanyaan ?></textarea>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="is_required" name="is_required" value="" required>
                                <option>Please Select</option>
                                <option value='1' <?php if ($pertanyaan_nps->is_required == "1") {
                                                        echo "selected";
                                                    } ?>>Aktif</option>
                                <option value='2' <?php if ($pertanyaan_nps->is_required == "2") {
                                                        echo "selected";
                                                    } ?>>Tidak Aktif</option>
                            </select>
                        </div>
