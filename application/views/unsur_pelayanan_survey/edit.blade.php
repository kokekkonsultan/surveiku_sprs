        ...
        <div class="col-md-9">
            ...
            <div class="card" data-aos="fade-down">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <?php echo form_open(base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/unsur-pelayanan-survey/edit/' . $ci->uri->segment(5)); ?>
                    @php
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <div class="input-group-prepend"><span
                                        class="input-group-text"><?php echo $data->nomor_unsur ?></span></div>
                                @php
                    ...
                    <!-- <div class="form-group row">
                        <label class="col-sm-3 col-form-label font-weight-bold">Sub Unsur Pelayanan <span style="color: red;">*</span></label>
                        <div class="col-sm-9">
                            <div>
                                <label>
                                    <input type="radio" name="custom" id="default" value="2" class="custom" {{ $data->is_sub_unsur_pelayanan == '2' ? 'checked' : ''}}>&nbsp Tanpa
                                    Sub
                                    Unsur</label><br>
                            </div>
                            <div>
                                <label>
                                    <input type="radio" name="custom" id="custom" value="1" class="custom" {{ $data->is_sub_unsur_pelayanan == '1' ? 'checked' : ''}}>&nbsp Dengan
                                    Sub
                                    Unsur</label><br>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="text-right">
                        ...
                        'Batal', ['class' => 'btn btn-light-primary font-weight-bold shadow'])
                        @endphp
...
$(function() {
    $(":radio.custom").click(function() {
        $("#id_parent").hide()
        if ($(this).val() == "1") {
            $("#id_parent").prop('required', true).show();
        } else {
