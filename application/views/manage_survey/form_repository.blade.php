  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <form action="{{ base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/setting-survei/periode' }}" class="form_pembuka">
                <div class="form-group row">
                    <label class="col-sm-5 col-form-label font-weight-bold">Tanggal Survei Dibuka <span class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <input type="date" name="survey_start" value="{{ $manage_survey->survey_start }}" id="survey_start" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row mt-5">
                    ...
                    <div class="col-sm-7">
                        <input type="date" name="survey_end" value="{{ $manage_survey->survey_end }}" id="survey_end" class="form-control">
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form
                        ...
                        <div class="row" name="pilih_sampling" id="pilih_sampling" <?= $manage_survey->is_sampling == 0 ? 'style="display:none;"' : '' ?>>
                            <div class="col-sm-6">
