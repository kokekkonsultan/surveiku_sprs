...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <div class="input-group-prepend"><span
                                class="input-group-text"><?php echo $current->nomor_pertanyaan_terbuka ?></span></div>
                        @php
            ...
            ?>
            <input type="text" name="id_kategori[]" value="<?php echo $row->id_isi_pertanyaan_ganda; ?>" hidden>
            <div class="form-group row">
